                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <!-- <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Data-data</span> -->
                                        <!-- <span class="pcoded-mcaret"></span> -->
                                    <!-- </a>
...
<div class="card-header">
    ...
    <div class="card-body">
    <a href="/tambah" class="btn btn-sm btn-danger">Tambah</a>
 </div>
     ...
     @endforeach
            ...
            <tbody> -->
                ...
                <!-- </tbody>
                                    ...
                                    <h4 class="mb-0"> Hallo, Selamat Datang {{ auth()->user()->name }} !
                                    </h4>
                                    </div>
                                    <p> </p>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block table-border-style">
                                            ...
                                            <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('dashboard/'.$r->id_bayar) }}" method="post">
                                            @csrf
                                            @method('DELETE')
