                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Masukan Data Pembayaran</h5>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form action="{{ route('insertbayar') }}" method="POST">
                                                                {{ csrf_field() }}
                                                                <!-- <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">ID Bayar</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Jumlah Bayar
                                                                        </label>
                                                                        <div class="col-sm-10">
